...
# [C4]'s Camera carries lat/lon at the top level, and web/map.js filters on `c.lat != null`.
# Nesting them under `geo` left every camera unplaced: the console showed "30 cameras, 0 placed"
# and an empty map, with the coordinates sitting right there in the payload.
...
def load_cameras() -> list[dict]:
    ...
    for cam in seed:
        ...
        for field in GEO_TOP_LEVEL:                 # added: what [C4] and the map expect
